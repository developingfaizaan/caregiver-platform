    ...
    <main className="flex">
      <section className="flex-1 w-full max-w-2xl m-auto px-5 md:px-12 sm:px-32 py-20">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Select label={language.ProfileType} value={form.role} onChange={(e) => setForm({ ...form, role: e.target.value.toLowerCase() })} items={Object.values(language.profiles)} itemValues={Object.keys(language.profiles)} />
